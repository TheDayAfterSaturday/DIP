...
/*----------------------------------------------------------------------------*/
/*    Copyright (c) National Instruments 1987-2012.  All Rights Reserved.     */
/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Title:       userint.h                                                     */
...
#define VAL_UPPER_RIGHT                 9L
	...
	/*** graph plot types (for ATTR_PLOT_TYPE): ***/
#define VAL_PLOT_X						0L
#define VAL_PLOT_Y						1L
#define VAL_PLOT_XY						2L
#define VAL_PLOT_WAVEFORM				3L
#define VAL_PLOT_POINT					4L
#define VAL_PLOT_TEXT					5L
#define VAL_PLOT_LINE					6L
#define VAL_PLOT_RECTANGLE				7L
#define VAL_PLOT_POLYGON				8L
#define VAL_PLOT_OVAL					9L
#define VAL_PLOT_ARC					10L
#define VAL_PLOT_INTENSITY				11L
#define VAL_PLOT_SCALED_INTENSITY		12L
#define VAL_PLOT_BITMAP					13L
...
#define ATTR_ANTI_ALIASED_PLOTS         ATTR_ENABLE_ANTI_ALIASING
...
int CVIFUNC_C SetRingItemAttribute (int panel, int control, int index, int attribute, ...);
...
int CVIFUNC GetRingItemAttribute(int panel, int control, int index, int attribute, void *value);
...
int CVIFUNC GetActiveLegendItem(int panel, int control, int *item);
...
int CVIFUNC FileSelectPopupEx(const char defaultDir[], const char defaultSpec[], const char fileTypeList[],
							  const char title[], int buttonLabel, int restrictDir, int restrictExt, char fileSpec[]);
...
int CVIFUNC MultiFileSelectPopupEx(const char defaultDir[], const char defaultSpec[], const char fileTypeList[],
								   const char title[], int restrictDir, int restrictExt, int *numSelected, char ***fileSpecList);
int CVIFUNC DirSelectPopup (const char defaultDir[], const char title[], int allowCancel,
							int allowMakeDir, char dirChosen[]);
int CVIFUNC DirSelectPopupEx(const char defaultDir[], const char title[], char dirChosen[]);
...
#endif
int CVIFUNC GetRealFontTypefaceName(char *fontName, char *typefaceName);
int CVIFUNC GetRealFontTypefaceNameLength(char *fontName, int *typefaceNameLength);
...
int     CVIFUNC_C SetTableCellRangeAttribute (int panel, int control, Rect cellRange, int attribute,
											...);
int     CVIFUNC_C SetTableCellRingItemAttribute (int panel, int control, Point cell, int ringItemIndex, 
												 int attribute, ...);
...
int     CVIFUNC GetTableCellAttribute (int panel, int control, Point cell, int attribute,
									   void *value);
int     CVIFUNC GetTableCellRingItemAttribute (int panel, int control, Point cell, int ringItemIndex, 
											   int attribute, void *value);
...
int	    CVIFUNC_C SetTreeColumnAttribute (int panel, int control, int column,
									  int attribute, ...);
int	    CVIFUNC GetTreeCellRingItemAttribute (int panel, int control, int item, int column,
									  int ringItemIndex, int attribute, void *value);
int	    CVIFUNC_C SetTreeCellRingItemAttribute (int panel, int control, int item, int column,
									  int ringItemIndex, int attribute, ...);
